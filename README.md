...
### 4. Quebra-Cabeça da Tabela Periódica
**Como funciona:** Arraste os elementos químicos para suas posições corretas na tabela periódica.

- **Objetivo:** Completar a tabela periódica arrastando todos os elementos para suas posições corretas
- **Mecânica:**
  - Os elementos aparecem embaralhados na parte inferior da tela
  - O jogador deve arrastar cada elemento para sua posição correta na tabela
  - Cada elemento possui seu símbolo, número atômico e categoria (metal, não-metal, etc.)
  - Sistema de dicas visuais para auxiliar na localização
  - Elementos ficam destacados quando posicionados corretamente

**Aprendizado:** Ensina a organização e estrutura da tabela periódica, grupos e períodos, classificação dos elementos e suas propriedades características.

## Como Jogar

### Instruções
1. **Acesse o jogo:** Abra o arquivo `index.html` no seu navegador
2. **Digite os nomes:** Insira os nomes dos jogadores (opcional)
3. **Escolha o jogo:** Clique em um dos 4 jogos disponíveis
...
├── imagens/ # Imagens dos elementos químicos e logos institucionais
│   ├── Na.png, Cl.png, Mg.png, O.png, etc. (elementos químicos flutuantes)
│   ├── faetec-logo.png, faperj-logo.png, iserj-logo.png (logos institucionais)
│   └── verso-institucional.png
├── sons/ # Efeitos sonoros utilizados nos jogos
│   ├── click-suave.mp3, som-combinacao.mp3, som-empate.mp3
│   ├── som-vitoria.mp3 e virar-carta.mp3

├── index.html # Página principal com menu de jogos
├── index.css # Estilos, animações da tela de início e partículas
├── particulas.js # Lógica por trás das animações de partículas químicas

├── memoriaLigacoes.html # Tela do jogo da Memória de Ligações Iônicas
├── memoriaLigacoes.css # Estilos e animações do jogo da Memória
├── memoriaLigacoes.js # Lógica do Jogo da Memória de Ligações

├── superTrunfo.html # Super Trunfo Químico
├── superTrunfo.css # Estilos e animações do jogo Super Trunfo
├── superTrunfo.js # Lógica do Super Trunfo Químico

├── balanceamento.html # Balanceamento de Equações Químicas
├── balanceamento.css # Estilos e animações do jogo de Balanceamento
├── balanceamento.js # Lógica do Balanceamento de Equações

├── tabelaPeriodica.html # Quebra-Cabeça da Tabela Periódica
├── tabelaPeriodica.css # Estilos e animações do jogo da Tabela Periódica
├── tabelaPeriodica.js # Lógica do Quebra-Cabeça da Tabela Periódica

├── sons.js # Gerenciamento de efeitos sonoros
└── README.md
...
### Jogo da Memória das Ligações
- **Ligações iônicas:** Como íons se combinam
- **Ligações covalentes:** Como as moléculas se juntam, compartilhando pares de átomos
...
- **Estequiometria:** Proporções entre reagentes e produtos
- **Conservação da massa:** Lei de Lavoisier
- **Coeficientes estequiométricos:** Balanceamento matemático
- **Reações químicas:** Representação simbólica

### Quebra-Cabeça da Tabela Periódica
- **Organização periódica:** Grupos e períodos
- **Classificação dos elementos:** Metais, não-metais, semimetais
- **Propriedades periódicas:** Tendências na tabela
- **Número atômico:** Identificação e localização
- **Estrutura eletrônica:** Configuração dos elétrons
